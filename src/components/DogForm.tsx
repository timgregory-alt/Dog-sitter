      ...
      <div className="flex items-center gap-4">
        <div className="flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-[var(--color-line)] bg-[var(--color-cream-deep)]">
          {photo ? (
            ...
            <span className="text-xs text-[var(--color-ink)]/40">No photo</span>
          )}
        </div>
        <div className="flex flex-col gap-2">
          <button
            ...
            disabled={photoBusy}
            className="flex items-center gap-1.5 rounded-full border border-[var(--color-line)] bg-white px-4 py-2 text-sm font-medium text-[var(--color-ink)] disabled:opacity-60"
          >
          ...
          {photo && (
            <button
              ...
              className="text-left text-xs text-[var(--color-ink-soft)] hover:underline"
            >
              Remove photo
            </button>
          )}
